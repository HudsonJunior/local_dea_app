class FrequentlyQuestionModel {
  ...
  const FrequentlyQuestionModel(this.question, this.answer);
}

const frequentlyQuestionsData = [
  FrequentlyQuestionModel("O que é o DEA?",
  ...
  FrequentlyQuestionModel("O que é PCR?",
  ...
  FrequentlyQuestionModel("O que é RCP?",
  ...
  FrequentlyQuestionModel("O que causa a PCR?",
  ...
  FrequentlyQuestionModel("Como reconhecer uma PCR?",
  ...
  FrequentlyQuestionModel("Parada Cardiorrespiratória é igual a infarto?",
  ...
  FrequentlyQuestionModel("Posso ferir acidentalmente a vítima com um DEA?",
  ...
  FrequentlyQuestionModel("Os DEAs sempre ajudam as vítimas de PCR?",
  ...
  FrequentlyQuestionModel("Onde os DEAs devem ser localizados?",
  ...
  FrequentlyQuestionModel("Os DEAs substituem o uso de RCP?",
  ...
  FrequentlyQuestionModel("É importante ter um DEA em minha casa?",
  ...
  FrequentlyQuestionModel("Como prevenir a PCR?",
  ...
  FrequentlyQuestionModel("Como a Parada Cardiorrespiratória deve ser tratada?",
